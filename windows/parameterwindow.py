...
class ParameterWindow(QDockWidget):
    ...
    def __init__(self, name, parent=None):
        ...
        self.z_particle.setValue(model.defaults['z_p'])
        ...
        self.diameter.setValue(model.defaults['diameter']*10**9)
